...
MONGODB_ADMIN_PASS=${MONGODB_ADMIN_PASS:-"projetocloud"}
 
# Application Database User
MONGODB_APPLICATION_DATABASE=${MONGODB_APPLICATION_DATABASE:-"admin"}
MONGODB_APPLICATION_USER=${MONGODB_APPLICATION_USER:-"marcelo"}
MONGODB_APPLICATION_PASS=${MONGODB_APPLICATION_PASS:-"projetocloud"}
 
# Wait for MongoDB to boot
RET=1
while [[ RET -ne 0 ]]; do
    echo "=> Waiting for confirmation of MongoDB smervice startup..."
    sleep 5
